...
public class Robot_72_Color extends BaseMode {
    ...
    @Override
    public String getName() { return "Robot 72 Color"; }

    @Override
    public int getVISCode() { return 12; }

    @Override
    public int getWidth() { return horizontalPixels; }

    @Override
    public int getHeight() { return verticalPixels; }

    @Override
    public int getFirstPixelSampleIndex() { return beginSamples; }

    @Override
    public int getFirstSyncPulseIndex() { return 0; }

    @Override
    public int getScanLineSamples() { return scanLineSamples; }
