...
public class SettingsActivity extends AppCompatActivity {
    ...
    private void populateSstvAudioOptions() {
        setDropdownOptions(R.id.sstvAudioSourceTextView, List.of("Radio", "Mic"));
        setDropdownOptions(R.id.sstvResampleRadioTextView, List.of("On", "Off"));
        setDropdownOptions(R.id.sstvRxPcmBypassTextView, List.of("On", "Off"));
    }
    ...
    private void populateOriginalValues(Runnable callback) {
        threadPoolExecutor.execute(() -> {
            ...
            runOnUiThread(() -> {
                ...
                setDropdownIfPresent(settings, AppSetting.SETTING_SSTV_AUDIO_SOURCE, R.id.sstvAudioSourceTextView);
                setDropdownIfPresent(settings, AppSetting.SETTING_SSTV_RESAMPLE_RADIO, R.id.sstvResampleRadioTextView);
                setDropdownIfPresent(settings, AppSetting.SETTING_SSTV_RX_PCM_BYPASS, R.id.sstvRxPcmBypassTextView);
                if (hasHighLowPowerSwitch) {
    ...
    private void attachListeners() {
        ...
        attachTextView(R.id.sstvAudioSourceTextView, this::setSstvAudioSource);
        attachTextView(R.id.sstvResampleRadioTextView, this::setSstvResampleRadio);
        attachTextView(R.id.sstvRxPcmBypassTextView, this::setSstvRxPcmBypass);
    ...
    private void setSstvAudioSource(String src) {
        saveAppSettingAsync(AppSetting.SETTING_SSTV_AUDIO_SOURCE, src);
    }

    private void setSstvResampleRadio(String value) {
        saveAppSettingAsync(AppSetting.SETTING_SSTV_RESAMPLE_RADIO, value);
    }

    private void setSstvRxPcmBypass(String value) {
        saveAppSettingAsync(AppSetting.SETTING_SSTV_RX_PCM_BYPASS, value);
    }
