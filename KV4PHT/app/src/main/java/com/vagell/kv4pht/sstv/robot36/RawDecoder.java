...
public class RawDecoder extends BaseMode {
    ...
    @Override
    public int getVISCode() { return -1; }
    ...
    @Override
    public int getFirstPixelSampleIndex() { return 0; }

    @Override
    public int getFirstSyncPulseIndex() { return -1; }

    @Override
    public int getScanLineSamples() { return -1; }
