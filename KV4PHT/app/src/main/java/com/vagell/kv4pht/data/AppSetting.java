...
public class AppSetting {
    ...
    public static final String SETTING_SSTV_AUDIO_SOURCE = "sstvAudioSource";
    public static final String SETTING_SSTV_RESAMPLE_RADIO = "sstvResampleRadio";
    public static final String SETTING_SSTV_RX_PCM_BYPASS = "sstvRxPcmBypass";
